...
namespace Bitbank.Models.Clients
{
    ...
    class PublicAPIClient : BaseClient
    {
        ...
        // ろうそく足取得メソッド
        public async Task<CandlestickResult> GetCandlestick(string CandleType, string YYYYMMDDD)
        {

            Uri _endpoint = new Uri((_HTTPConn.Client.BaseAddress).ToString() + "btc_jpy/candlestick/" + CandleType + "/" + YYYYMMDDD);
