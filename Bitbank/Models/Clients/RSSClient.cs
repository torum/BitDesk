...
namespace Bitbank.Models.Clients
{
    public enum Langs
    {
        en, ja
    ...
    public class RSSClient : BaseClient
    {
        ...
        public RssResult GetRSS(Langs lang)
        {
            ...
            //System.Diagnostics.Debug.WriteLine("GettingGetRSS...");
            ...
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    //System.Diagnostics.Debug.WriteLine("GetRSS: " + s);
                ...
                {
                    System.Diagnostics.Debug.WriteLine("GetRSS: HTTP Error " + response.StatusCode.ToString());
            ...
            {
                System.Diagnostics.Debug.WriteLine("GetRSS: HttpRequestException - " + ex.Message + " + 内部例外: " + ex.InnerException.Message);
