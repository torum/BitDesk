...
namespace BitDesk.ViewModels
{
    ...
    /// v0.5.4 自動取引関連のコード削除洩れを掃除。資産情報の小数点以下の桁数を修正。
    /// v0.5.3 自動取引機能を削除。自動取引はBitAutoへ移行。
    /// v0.5.2 注文リストの約定済みアイテムは削除するように変更。
    /// </summary>
    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        // テスト用
        private decimal _initPrice = 500000M;
